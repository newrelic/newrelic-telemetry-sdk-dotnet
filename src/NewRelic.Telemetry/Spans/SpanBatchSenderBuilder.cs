...
//            IBatchDataSender sender = new BatchDataSender(_apiKey, TraceUrl, _auditLoggingEnabled, TimeSpan.FromSeconds(5));
            IBatchDataSender sender = new BatchDataSender(Configuration.ApiKey, Configuration.TraceUrl, Configuration.AuditLoggingEnabled, TimeSpan.FromSeconds(5));

            ////////////// testing
            //var config = new Configuration();
            //var configSetting = config.GetConfigValue("testAppSetting");
