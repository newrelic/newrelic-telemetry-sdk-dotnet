...
namespace NewRelic.Telemetry.Metrics
{
    ...
    //{
    //    IMetricBuilder WithAttribute(string attribName, object attribValue);
    //    IMetricBuilder WithAttributes(ICollection<KeyValuePair<string, object>> attributes);
    //    IMetricBuilder WithIntervalMs(long intervalMs);
    //    IMetricBuilder WithTimestamp(DateTime timestamp);
    //    IMetric Build();
    //}
    ...
    ///// </summary>
    //public abstract class Metric : IMetricBuilder, IMetric
    //{
    //    /// <summary>
    ...
    //    public IMetricBuilder WithTimestamp(DateTime timestamp)
    //    {
    ...
    //    public IMetricBuilder WithIntervalMs(long intervalMs)
    //    {
    ...
    //    public IMetricBuilder WithAttribute(string attribName, object attribValue)
    //    {
    ...
    //    /// <returns></returns>
    //    public IMetricBuilder WithAttributes(ICollection<KeyValuePair<string, object>> attributes)
    //    {
    //        if (attributes == null)
    //        {
    //            return this;
    ...
    //{
    //    public static IMetricBuilder Create(string name, double value)
    //    {
    ...
    //{
    //    public static IMetricBuilder Create(string name, double count, double sum, double min, double max)
    //    {
    //        return new SummaryMetric(name, count, sum, min, max);
    //    }

    //    public static IMetricBuilder Create(string name, double count, double sum)
    //    {
